...
def get_args():
    ...
    parser.add_argument("--stream", type=int, default=4000)     ## 20*200 
    ...
    parser.add_argument("--catergory_num", type=int, default=200) # 测100类 还是 1k类
    parser.add_argument("--batch_size", type=int, default=1)
    parser.add_argument("--epoch", type=int, default=10)
    parser.add_argument("--num", type=int, default=1000)  
    parser.add_argument("--alpha", type=float, default=0.2)
    parser.add_argument("--online", type=str, default="fixed") #baseline
